...
const (
	...
	// ReasonInvalidServiceMonitorConfiguration when the service monitor cannot be created
	// invalid configuration of service monitor
	ReasonInvalidServiceMonitorConfiguration LokiStackConditionReason = "InvalidServiceMonitorConfiguration"
)
