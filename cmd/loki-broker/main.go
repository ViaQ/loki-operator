...
func (c *config) registerFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&c.featureFlags.EnableLokiStackGateway, "with-lokistack-gateway", false, "Enables the manifest creation for the entire lokistack-gateway.")
	f.BoolVar(&c.featureFlags.EnableLokiStackGatewayTLSListener, "with-lokistack-gateway-tls-listener", false, "Configure the lokistack-gateway TLS listener.")
